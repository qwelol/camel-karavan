            ...
            set((state: IntegrationState) => {
                ...
                if (state.json === json) {
                    return {
                        ...
                        propertyOnly: state.propertyOnly,
                        json: state.json,
                    };
                } else {
...
export const useSelectorStore = createWithEqualityFn<SelectorStateState>(
    (set) => ({
        showSelector: false,
        deleteMessage: '',
        parentId: '',
...
export const useConnectionsStore = createWithEqualityFn<ConnectionsState>(
    (set) => ({
...
export const useDesignerStore = createWithEqualityFn<DesignerState & DesignerAction>(
    (set) => ({
        ...designerState,
