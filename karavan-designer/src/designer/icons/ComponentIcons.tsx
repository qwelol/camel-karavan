...
export function SmooksIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 90 79' className='icon' width='32px' height='32px'>
...
export function DirectIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' className='icon' width='32px' height='32px'>
            <path d='M25 11a5.008 5.008 0 0 0-4.899 4H11.9a5 5 0 1 0 0 2H20.1A5 5 0 1 0 25 11Zm0 8a3 3 0 1 1 3-3 3.003 3.003 0 0 1-3 3Z' />
            <path
                d='M0 0h32v32H0z'
...
export function DatabaseIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='icon' width='32px' height='32px'>
            <path
                fillRule='evenodd'
...
export function CloudIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' className='icon' width='32px' height='32px'>
            <path d='M16 7a7.66 7.66 0 0 1 1.51.15 8 8 0 0 1 6.35 6.34l.26 1.35 1.35.24a5.5 5.5 0 0 1-1 10.92H7.5a5.5 5.5 0 0 1-1-10.92l1.34-.24.26-1.35A8 8 0 0 1 16 7m0-2a10 10 0 0 0-9.83 8.12A7.5 7.5 0 0 0 7.49 28h17a7.5 7.5 0 0 0 1.32-14.88 10 10 0 0 0-7.94-7.94A10.27 10.27 0 0 0 16 5Z' />
            <path
                d='M0 0h32v32H0z'
                style={{
                    fill: 'none',
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <image
                    xlinkHref='data:image/png;base64,'
                    width={43.164}
                    height={31.532}
                    x={31.672}
                    y={6.587}
                ...
                <image
                    xlinkHref='data:image/png;base64,'
                    width={111.814}
                    height={32.542}
                    x={1.822}
                    y={1.682}
...
export function ActivemqIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30.803 44.324' className='icon' width='32px' height='32px'>
            <defs>
                <filter id='a' width={1.068} height={1.046} x={-0.017} y={-0.011}>
...
export function SapIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1024 1024' className='icon' width='32px' height='32px'>
            <circle
                cx={512}
                cy={512}
                r={512}
...
export function RedisIcon() {
    return (
        ...
        >
            ...
            />
            <path fill='#621B1C' d='m185.295 35.998 34.836 13.766-34.806 13.753-.03-27.52' />
            <path fill='#9A2928' d='m146.755 51.243 38.54-15.245.03 27.519-3.779 1.478-34.791-13.752' />
        </svg>
    );
}
...
export function KameletIcon() {
    return (
        <svg className='icon' id='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'>
...
export function CouchbaseIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={800} height={800} viewBox='0 0 256 256' className='icon'>
            <path
                fill='#ED2226'
...
export function AzureIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96' className='icon' width='32px' height='32px'>
            <defs>
                <linearGradient
                    id='a'
                    x1={-1032.172}
