...
export function LoadBalanceIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' className='icon' width='32px' height='32px'>
            <path d='M4 26h4v4H4zM14 26h4v4h-4zM24 26h4v4h-4zM25 16h-8v-2h-2v2H7a2.002 2.002 0 0 0-2 2v6h2v-6h8v6h2v-6h8v6h2v-6a2.002 2.002 0 0 0-2-2ZM9 2v10h14V2Zm2 2h2v6h-2Zm10 6h-6V4h6Z' />
            <path
                d='M0 0h32v32H0z'
...
export function ToIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={800} height={800} viewBox='0 0 32 32' className='icon'>
            <path d='m12.103 11.923 2.58 2.59H2.513v2h12.17l-2.58 2.59 1.41 1.41 5-5-5-5z' />
            <path d='M9.513 23.013v-.5h2v.5a4.504 4.504 0 0 0 9 .36v-.86l.82-.1a7 7 0 0 0 0-13.88l-.82-.02v-.86a4.504 4.504 0 0 0-9 .36v.5h-2v-.5a6.5 6.5 0 0 1 12.86-1.3 9 9 0 0 1 0 17.6 6.5 6.5 0 0 1-12.86-1.3z' />
            <path
                d='M0 0h32v32H0z'
                data-name='&lt;Transparent Rectangle&gt;'
                style={{
...
export function PollIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={800} height={800} viewBox='0 0 32 32' className='icon'>
            ...
            <path d='M10.013 23.513v-.5h2v.5a4.504 4.504 0 0 0 9 .36v-.86l.82-.1a7 7 0 0 0 0-13.88l-.82-.02v-.86a4.504 4.504 0 0 0-9 .36v.5h-2v-.5a6.5 6.5 0 0 1 12.86-1.3 9 9 0 0 1 0 17.6 6.5 6.5 0 0 1-12.86-1.3z' />
    ...
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 700 700' className='icon' width='32px' height='32px'>
            <defs>
                <style>
                    {
                        '.b{stroke-linejoin: round;}.b,.c {stroke-linecap: round;}.b,.c,.d {fill: none;stroke: #000;stroke-width: 35px;}.c,.d {stroke-miterlimit: 10;}'
                    }
                </style>
            </defs>
