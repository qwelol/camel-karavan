        ...
        >
            <defs id='defs31'>
                <linearGradient id='linearGradient1351'>
                    <stop id='stop1347' offset='0' stopColor='#dcffff' stopOpacity='1'></stop>
                    <stop id='stop1349' offset='1' stopColor='#96d2e6' stopOpacity='1'></stop>
                </linearGradient>
                ...
                >
                    <stop id='stop10' offset='0%' stopColor='#4790bb' stopOpacity='1'></stop>
                    <stop id='stop12' offset='10.996%' stopColor='#64b7db' stopOpacity='1'></stop>
                    <stop id='stop14' offset='94.502%' stopColor='#326ea0' stopOpacity='1'></stop>
                </linearGradient>
                <linearGradient
                    id='linearGradient-4'
                    x1='-32.163'
                ...
                >
                    <stop id='stop24' offset='0%' stopColor='#92d6d5' stopOpacity='1'></stop>
                    <stop id='stop26' offset='41.191%' stopColor='#79b7cc' stopOpacity='1'></stop>
                    <stop id='stop28' offset='73.271%' stopColor='#5891c5' stopOpacity='1'></stop>
                </linearGradient>
...
export function CamelIcon(props?: (JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) | undefined) {
    return (
        ...
        >
            <defs>
                <linearGradient id='b' x1='-12.564%' x2='101.304%' y1='108.214%' y2='-1.964%'>
                    <stop offset='0%' stopColor='#F69923' />
                    <stop offset='10.996%' stopColor='#F79A23' />
                    <stop offset='94.502%' stopColor='#E97826' />
                </linearGradient>
                <linearGradient id='d' x1='-12.564%' x2='101.304%' y1='108.214%' y2='-1.964%'>
                    <stop offset='0%' stopColor='#F69923' />
                    <stop offset='8.048%' stopColor='#F79A23' />
                    <stop offset='41.874%' stopColor='#E97826' />
                </linearGradient>
                <linearGradient id='e' x1='74.724%' x2='6.653%' y1='-3.059%' y2='100.066%'>
            ...
            <circle cx={127.994} cy={127.994} r={123.111} fill='url(#b)' mask='url(#c)' />
            <path
                fill='url(#d)'
                d='M128 256C57.308 256 0 198.692 0 128 0 57.308 57.308 0 128 0c70.692 0 128 57.308 128 128 0 70.692-57.308 128-128 128Zm0-9.768c65.298 0 118.232-52.934 118.232-118.232S193.298 9.768 128 9.768 9.768 62.702 9.768 128 62.702 246.232 128 246.232Z'
                mask='url(#c)'
...
export function getDesignerIcon(icon: string): React.JSX.Element {
    if (icon === 'kamelet')
        return (
            <svg className='top-icon' id='icon' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'>
    ...
    if (icon === 'routeConfiguration')
        return (
            <svg className='top-icon' width='32' height='32' viewBox='0 0 32 32'>
                ...
                <path d='M0 0H32V32H0z' fill='none' data-name='&lt;Transparent Rectangle&gt;'></path>
            </svg>
        );
    if (icon === 'yaml')
        return (
            <svg className='top-icon' x='0px' y='0px' width='32px' height='32px' viewBox='0 0 32 32'>
