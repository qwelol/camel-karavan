...
import { DslBeanPropertiesField } from '../components/DslBeanPropertiesField';

export class DslBeanPropertiesFieldRenderer implements DslRenderer {
    canRender(property: PropertyMeta, props: DslRendererProps): boolean {
        ...
        return beanConstructors || beanProperties;
    }

    render(props: DslRendererProps): React.ReactElement {
        return <DslBeanPropertiesField {...props} />;
    }
