...
export function DeleteElementIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' viewBox='0 0 32 32' className='delete-button-icon'>
...
export function AddElementIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' viewBox='0 0 32 32' className='add-button-icon'>
...
export function InsertElementIcon() {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' xmlSpace='preserve' viewBox='0 0 32 32' className='insert-button-icon'>
